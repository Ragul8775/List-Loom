...
export default function Home() {
  return (
    <ProtectedRoute>
      <Layout>
        <div className="flex flex-col items-center justify-start h-screen gap-4 my-4">
          <div className=" border border-gray-200 rounded-lg font-sans flex justify-around  gap-8 py-4 px-8 w-full container mx-auto">
          ...
          <div className="container gap-4 flex  w-full">
            <ProjectList />
            <MyTask />
          </div>
          <RecentlyViewed />
